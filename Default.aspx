   ...
   <article class="midleBox">
        ...
        <div class="col-md-12">
            ...
            <li>
                ...
                <a class="btn btn-primary" runat="server" href="~/Views/HardcorePorn">Best Games &raquo;</a>             
            </li>
             <li>
                 <span>
                    <img src="App_Themes/news.png" font style="vertical-align:inherit" />
                </span>
                <a class="btn btn-primary" runat="server" href="https://www.gamcore.com/games/inner_bimbo/fgn.cdn.serverable.com/common/flashes/nf/inner_bimbo/index.html">New Games &raquo;</a>
              </li>   
            <li>
                <span>
                    <img src="App_Themes/popular.png" font style="vertical-align:inherit" />
                </span>
                <a class="btn btn-primary" runat="server" href="~/Views/BlowJob">Popular Games &raquo;</a>
            </li>
            <%--<li>
            ...
            <li>
                ...
                <a class="btn btn-primary" runat="server" href="~/Views/BigTits">Top Favourites &raquo;</a>
            </li>
             <%--    <li>
