<%@ Page Title="PopularGames" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PopularGames.aspx.cs" Inherits="webmvc.PopularGames" %>
       ...
       <div>
        ...
        <div class="col-12 col-sm12 col-md-10 col-lg-7 midcontent"> 
            ...
            <div class="all_items last_coment">
                <h1>Popular Games on NothinGames</h1>
                <div class="item">
                    <div class="row">
